...
| CS – 9 | Testing of Hypothesis - mean and proportions related models (one mean, two mean, one proportion and Several proportions with small and big samples wherever applicable) | T1 & T2 |
| CS – 10 | Maximum likelihood, ANOVA – Single and dual factor | T1 & T2 |
...
Note: The table may appear misaligned in a plain text format, but when rendered in Markdown, it will be properly formatted.
...
| CS2 | Mathematical Preliminaries, Linear Algebra, Calculus, Probability theory, Bayes Theory, Probability Densities, Gaussian Distribution, Decision Theory, Minimum Misclassification Rate, Information Theory, Measure of Information, Entropy | Lecture Notes, R1 – Ch2 |
| CS3 | Bayesian Learning, MLE Hypothesis, MAP Hypothesis, Minimum Description Length (MDL) principle | T1 - Ch. 6 |
| CS4 | Bayesian Classifiers, Bayes optimal classifier, Gibbs Algorithm, Naïve Bayes Classifier | T1 - Ch. 6 |
| CS5 | Linear models for classification, Discriminant Functions, Probabilistic Generative Classifiers, Probabilistic Discriminative Classifiers, text classification model, image classification | T1 – Ch. 6, R1 - Ch. 4 |
| CS6 | Linear models for Regression, Linear basis function models, Bayesian linear regression, Bias-variance decomposition | R1 - Ch. 3, T1 – Ch. 6 |
| CS7 | Decision Tree, Decision Trees construction, entropy models, issues in decision tree learning, random forest | T1 - Ch. 3 |
| CS8 | Review of Session 1 to 7 | Books, Web references and Slides |
| CS9 | Neural Network, Perceptron, neural network architecture, Back propagation | T1 - Ch. 4, R1 - Ch. 5 |
| CS10 | Neural Network, Convolutional network, recurrent network | T1 - Ch. 4, R1 - Ch. 5 |
| CS11 | Instance-based Learning, K-Nearest Neighbor Learning, Locally Weighted Regression (LWR) Learning, Radial Basis Functions | T1 - Ch. 8 |
| CS12 | Ensemble, Bagging, Boosting, AdaBoost, Gradient Boosting | Lecture Notes |
| CS13 | Support Vector Machine -I, Theory of SVM, VC dimension, Linearly separable data | R2 |
| CS14 | Support Vector Machine - II, Non-linearly separable data, Kernel Trick | T1 - Ch. 6, R1 - Ch. 9 |
| CS15 | Unsupervised Learning, Mixture Models, EM algorithm, K-means Clustering | Lecture Notes|